# FROM from https://github.com/srianant/kalman_filter_multi_object_tracking/blob/master/object_tracking.py
...
video = '7-7-21_21-BA2_2B'
input_vidpath = 'hayley_daniela/ant_tracker/input/' + video + '.mp4'
output_vidpath = 'hayley_daniela/ant_tracker/output/' + video + '_tracked.mp4'
output_filepath = 'hayley_daniela/ant_tracker/output/' + video + '_tracked.csv'
