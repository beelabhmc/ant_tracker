...
"""
BEWARE:
    An easy pitfall of interpreting these plots is to think the x-axis
    represents time.
    It doesn't! Each row in the raw_results is an appearance of an ant
    in a frame, so moments when there aren't any ants on the screen are
...
def main():
    ...
    arg_parser.add_argument('--i',
                            ...
                            required = True,
                            type=str,
                            help='path to some raw coordinate data that '
                                 'we should plot')
