...
def annotate_video(video_path: str, out_path: str):
...
if __name__ == "__main__":
    ...
    parser.add_argument("video", nargs='?', default="/home/livia/AntTrack/ant_tracker/clip_60s.mp4",
                        help="Input video path")
    parser.add_argument("out", nargs='?', default="/home/livia/AntTrack/ant_tracker/60s_clip_ants_annotated.mp4",
    ...
    parser.add_argument("--radius", type=float, default=None,
                        help="Optional radius to use instead of computing from center and north point.")
    ...
    if args.center is not None and args.north is not None:
        cx, cy = args.center
        nx, ny = args.north
        radius = args.radius if args.radius is not None else math.hypot(nx - cx, ny - cy)
        north_angle = angle_deg_from_center_to_point(cx, cy, nx, ny)
